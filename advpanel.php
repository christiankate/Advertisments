	...
	<div class="navbar">
		...
		<div class="navbar_items">
			<ul>
                ...
                <li><a href="viewms.php">Suggestions</a></li>
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            echo "<td>" . $row['Order_Id'] . "</td>";
             echo "<td><img src='images/$image' </td>";
                ...
                <td><a href="update.php?Order_Id=<?php echo $row["Order_Id"]; ?>">Modify</a>&nbsp;&nbsp;&nbsp;<a href="delete.php?Order_Id=<?php echo $row["Order_Id"]; ?>">Delete</a></td>
           <?php echo "</tr>";
            echo "</tbody>"; 
        } 
        echo "</table>";
