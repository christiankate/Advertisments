...
<div class="main_container" id="home">
	<div class="navbar">
		...
		<div class="navbar_items">
			<ul>
                <li><a href="customersorders.php">Adverts</a></li>
    ...
    <div class="table_responsive">
      ...
      <?php
include "db.php";
$sql = "SELECT orders.ProductImage,orders.ProductName,orders.ProductCategory from orders join favorites on orders.Order_Id=favorites.Order_Id";
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
           ...
           $image = $row['ProductImage'];
              ...
              <!--<td><a href="dltsms.php?Order_Id=<?//php echo $row["Order_Id"]; ?>">Remove</a></td>-->
           <?php echo "</tr>";
            echo "</tbody>"; 
        } 
        echo "</table>";
